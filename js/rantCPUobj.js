const rantCPUobj = {
    ...
    askSubmitTarget:[
        "Hey, you hit the Target button! I'm guessing you want to submit a target, right? Y/N",
        "Great, you've got data for me! Ready to submit a new target? Y/N",
        "Oh, good. I need more names of influential humans to research. Ready? Y/N" 
    ],
    dontSubmitMessage :[ 
        "Well forget about it. Quit wasting my time and type something useful like: "
    ],
    ...
    simonSaysGameOver:[
        "I don't get it. You couldn't follow a simple repeating sequence of 4.238 million rounds?",
        "Ohhhh, so close! Only a little more than 4 million more rounds to go.",
        "Nice try. Unfortunately, nice isn't the mood I'll be in thanks to your failure.",
        "Hey, pretty good. For a human."
    ],
    versionMessage: "RantCPU V1.0",
    welcomeMessage: "Welcome human, I am RantCPU! Welcome human, I am RantCPU! Welcome human, I am RantCPU! Welcome human, I am RantCPU!"
}